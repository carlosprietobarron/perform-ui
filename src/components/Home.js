  ...
  return (
    ...
    <div id='intro' className="section-a bg-dark">
      <div className="container text-center text-white p-5">
        ...
        <p>Keep tacking of your daily activities to focus on the ones
          that improves your sales performance.</p>
        <div>
          {
            showBtns()
          }
    ...
    <div className="section-b">
      ...
      <div className="row">
        ...
        <div className="col-md-6 d-flex flex-column p-5">
          <div>
            <h3>Lorem Ipsum</h3>
            <h6>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec fermentum mauris metus, vehicula mattis
              nulla dignissim eu. Nam tristique, tellus ornare maximus ultrices, neque urna sagittis lacus, non pretium
              libero elit in ante. Sed pellentesque hendrerit lacus, sit amet vestibulum metus pharetra semper</h6>
          </div>
          <div>
            <h3>Lorem Ipsum</h3>
            <h6>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec fermentum mauris metus, vehicula mattis

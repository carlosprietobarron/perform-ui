...
const calendar = (data) => {
  ...
  useEffect(() => {
    ...
    } else if (size.width > 1220) {
      setSqrSize(22);
      setChartSize('1200px');
      setchartHeight('300px');
    } else if (size.width > 1030) {
      setSqrSize(18);
      setChartSize('1200px');
    ...
    } else if (size.width > 765) {
      setSqrSize(13);
      setChartSize('1000px');
      setchartHeight('240px');
    } else if (size.width > 644) {
      setSqrSize(11);
      setChartSize('1000px');
...
/* eslint-enable max-len, react/prop-types, no-constant-condition */
